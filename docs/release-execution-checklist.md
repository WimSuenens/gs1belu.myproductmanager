...
publishing is fully activated as of this writing (see below) — the pattern
generalizes: each package needs its own trust relationship registered independently
before its first tag can publish.
