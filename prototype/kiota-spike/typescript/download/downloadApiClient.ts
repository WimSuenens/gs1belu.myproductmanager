...
/**
 * Instantiates a new {@link DownloadApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createDownloadApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<DownloadApiClient>(requestAdapter, pathParameters, DownloadApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface DownloadApiClient extends BaseRequestBuilder<DownloadApiClient> {
    /**
 ...
 */
export const DownloadApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const DownloadApiClientNavigationMetadata: Record<Exclude<keyof DownloadApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    tradeitems: {
