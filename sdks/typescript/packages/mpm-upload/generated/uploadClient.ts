...
// @ts-ignore
import { TradeitemsRequestBuilderNavigationMetadata, TradeitemsRequestBuilderRequestsMetadata, type TradeitemsRequestBuilder } from './tradeitems/index.js';
// @ts-ignore
...
/**
 * Instantiates a new {@link UploadClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createUploadClient(requestAdapter: RequestAdapter) {
    ...
    if (requestAdapter.baseUrl === undefined || requestAdapter.baseUrl === null || requestAdapter.baseUrl === "") {
        requestAdapter.baseUrl = "https://api.gs1belu.org/myproductmanager/upload/v17";
    }
    const pathParameters: Record<string, unknown> = {
        "baseurl": requestAdapter.baseUrl,
    };
    return apiClientProxifier<UploadClient>(requestAdapter, pathParameters, UploadClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface UploadClient extends BaseRequestBuilder<UploadClient> {
    /**
 ...
 */
export const UploadClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const UploadClientNavigationMetadata: Record<Exclude<keyof UploadClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    tradeitems: {
        requestsMetadata: TradeitemsRequestBuilderRequestsMetadata,
        navigationMetadata: TradeitemsRequestBuilderNavigationMetadata,
    },
};
/* tslint:enable */
/* eslint-enable */
