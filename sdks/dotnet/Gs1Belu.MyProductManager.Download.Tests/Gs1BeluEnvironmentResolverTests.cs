...
public class Gs1BeluEnvironmentResolverTests
{
    ...
    public void Uat_derives_the_uat_hosts_and_audience()
    {
        ...
        Assert.Equal("https://api-uat.gs1belu.org/myproductmanager/download/v17", Gs1BeluEnvironmentResolver.BaseUrl(Gs1BeluEnvironment.Uat, "v17"));
    }
    ...
    {
        Assert.Equal("https://api.gs1belu.org/myproductmanager/download/v18", Gs1BeluEnvironmentResolver.BaseUrl(Gs1BeluEnvironment.Prod, "v18"));
    }
}
